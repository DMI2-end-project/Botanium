<template>
  <div class="relative flex flex-col items-center text-center my-auto">
    ...
    <div class="w-full min-h-[200px] max-h-[300px] flex flex-col justify-center items-center gap-6 bg-green rounded-md p-10 -mt-6">
    ...
    <RoundButton v-if="mainStore.role === ROLE.TEACHER" @click="next" :color="gameStore.data.colorButton" class="mt-8 text-lg font-bold" :is-active="mainStore.role === ROLE.TEACHER && ((microNeeded && !hasMicroWaiting) || !microNeeded)">
