  ...
  <div class="w-3/4 mx-auto">
    <div class="flex justify-around gap-24">
      <div v-for="(team, index) in playingTeams" :v-bind="index"
           ...
           :class="cardState(index) === 'validated' ? 'bg-green' : 'bg-yellow' + (cardState(index) === 'show' ? '-outline-offset-2' : 'outline-offset-8')">
        <img alt="" :src="publicPath + '/game/images/00103/' + answers[index].image"
             class="grayscale brightness-50 w-2/5 opacity-30">
        <div
