<template>
  <div class="w-3/4 mx-auto">
    <div class="flex justify-around gap-24">
      <div v-for="(team, index) in playingTeams" :v-bind="index" class="box relative flex-1 max-w-[25vw] h-[20vw] outline-2 outline-dashed outline-white rounded-lg  flex flex-col items-center justify-center" :class="cardState(index) === 'validated' ? 'bg-green' : 'bg-yellow' + (cardState(index) === 'show' ? '-outline-offset-2' : 'outline-offset-8')">
