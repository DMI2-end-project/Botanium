<template>
  <div class="template-content grid grid-cols-2 gap-4 w-full h-full">
    <ImageElement :pageId="pageContent.id" :slotNumber="0" :isPageLeft="pageContent.pageNumber % 2 === 1" @onModify="$emit('onModify', $event)" />
