...
import { getPageData, getTextData, getDefaultTextData, getDrawData, getDrawFormData, getDefaultDrawData, getPhotoData, getDefaultPhotoData, getStickerData, getDefaultStickerData } from './Lib';
